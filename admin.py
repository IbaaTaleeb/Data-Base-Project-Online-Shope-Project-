...
class AdminGUI:
    def __init__(self, root, connection, cursor):
        ...
        # view all Product
        self.button_view_all_Product = ttk.Button(text="View All Product", command=self.view_all_Product,style="TBlackButton.TButton", width=45)
        ...
        try:
            ...
            if max_payment_orders_info:
                ...
                for order_info in max_payment_orders_info:
                    ...
                    order_info_text += f"Payment: {order_info[4]}\n"
